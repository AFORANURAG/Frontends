...
export default function SectionOne(): JSX.Element {
  return (
    <section className="bg-[#f5f5f5]">
      <div className="bg-no-repeat  bg-bottom bg-SectionOneRightBGRight font-sans min-h-[500px] h-[600px]">
        <div className="flex flex-row justify-around ml-36">
          {/**
           * left side section
           */}
          <div className="flex flex-col text-left justify-center font-normal pb-16 pt-16 tracking-widest">
            ...
            <div className="text-[56px] mb-8 tracking-wider">point of view</div>
            ...
            <div className="flex flex-row gap-3 mt-16 mb-3">
              <div>
                <button className=" py-2 px-10 text-sm font-semibold w-42 h-10  text-[14px] rounded leading-5	text-center">
                  Download App
                </button>
              </div>
              <div>
                <button className=" py-2 px-10 text-sm font-semibold w-42 h-10  text-[14px] rounded leading-5	text-center bg-black text-white">
                  Trade Online
                </button>
              </div>
            </div>
